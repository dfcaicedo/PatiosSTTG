...
Partial Class frmdeudores
    ...
    Private Sub InitializeComponent()
        ...
        Me.DeudoresviewTableAdapter1 = New AmbrosiaWPF.ambrosiapark_proDataSetTableAdapters.deudoresviewTableAdapter()
        Me.deudoresreport1 = New AmbrosiaWPF.deudoresreport()
        ...
        '
        'DeudoresviewTableAdapter1
        '
        Me.DeudoresviewTableAdapter1.ClearBeforeFill = True
        '
        'frmdeudores
        '
    ...
    Friend WithEvents deudoresreport1 As deudoresreport
    Friend WithEvents Ambrosiapark_proDataSet1 As ambrosiapark_proDataSet
    Friend WithEvents DeudoresviewTableAdapter1 As ambrosiapark_proDataSetTableAdapters.deudoresviewTableAdapter
End Class
