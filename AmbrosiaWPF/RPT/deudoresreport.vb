...
Public Class deudoresreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmbrosiaWPF.deudoresreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheddeudoresreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As deudoresreport = New deudoresreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
