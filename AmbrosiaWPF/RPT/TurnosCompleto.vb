...
Public Class TurnosCompleto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmbrosiaWPF.TurnosCompleto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTurnosCompleto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TurnosCompleto = New TurnosCompleto()
        rpt.Site = Me.Site
        Return rpt
    End Function
